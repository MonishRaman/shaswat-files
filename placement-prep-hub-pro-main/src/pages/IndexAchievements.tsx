...
import { Briefcase, GraduationCap, Lightbulb, Rocket, Building, Users, Award, Globe, Trophy } from 'lucide-react';

const IndexAchievements: React.FC = () => {
...
export default IndexAchievements;
