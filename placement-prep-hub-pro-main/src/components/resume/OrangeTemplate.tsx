...
interface OrangeTemplateProps {
  data: ResumeData;
}

export const OrangeTemplate: React.FC<OrangeTemplateProps> = ({ data }) => {
  return (
    <div className="flex flex-col md:flex-row min-h-[800px]">
      {/* Left sidebar */}
      <div className="bg-[#ff6b35] text-white w-full md:w-64 p-6 flex flex-col">
      ...
      <div className="bg-white flex-1 p-6">
        ...
        <hr className="border-[#ff6b35]/20 my-4" />
        
        <div className="mb-6">
          <h2 className="text-xl font-bold text-[#ff6b35] flex items-center gap-2 mb-3">
